"""
Django settings for vvcbc_dev_118865 project.
...
ROOT_URLCONF = 'vvcbc_dev_118865.urls'
...
WSGI_APPLICATION = 'vvcbc_dev_118865.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vvcbc_dev_118865 API",
    "DESCRIPTION": "API documentation for vvcbc_dev_118865 App",
    "VERSION": "v1",
}
